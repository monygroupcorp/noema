...
3. ✅ **Model publishing + custody preferences** — SHIPPED 2026-06-21. One registry-parameterized
   ...
   **live-unverified** (§10). Civitai still has no public upload API. The royalty payee (§5e) is the model's
   own `auctor`, unchanged by publish.
