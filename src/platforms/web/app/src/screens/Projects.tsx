    ...
    <AppShell crumb="projects">
      <div className="page"><div className="pw wide">
        <div className="pagehead">
          ...
          <div className="right"><button className="btn" onClick={() => alert('new project (todo)')}><Ic name="plus" /> New project</button></div>
        </div>
        ...
        <div className="projgrid">
          {projects.map((p) => {
            ...
            return (
              <button key={p.id} className={`projcard${active ? ' on' : ''}`} onClick={() => setProject(p.id)}>
        ...
        <div className="wsgrid">
          <div className="wscol">
            <div className="wshead"><Ic name="message-square" /> Chats <Link to="/">open →</Link></div>
