      ...
      bodyCard = h('div', { className: 'fd-card fd-card-params' },
        ...
        h('div', { className: 'fd-expr-help' },
          ...
          showExprHelp ? h('div', { className: 'fd-expr-help-body' },
            ...
            h('div', { className: 'fd-expr-help-section' },
              h('div', { className: 'fd-expr-help-title' }, 'Multi-line'),
              h('div', { className: 'fd-expr-help-item' }, 'Each line runs in order. Result of each line becomes "input" for the next.'),
              h('div', { className: 'fd-expr-help-item' }, 'Lines starting with # are comments.'),
            ),
            h('div', { className: 'fd-expr-help-section' },
              ...
              h('div', { className: 'fd-expr-help-item fd-expr-help-code' }, '# multi-line pipeline:\nreplace(input, "old", "new")\ntoUpperCase(input)'),
              h('div', { className: 'fd-expr-help-desc' }, 'Chain transforms — replace then uppercase'),
            ),
            h('div', { className: 'fd-expr-help-section' },
