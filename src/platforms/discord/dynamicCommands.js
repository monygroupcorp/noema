              ...
              switch (code) {
                case 'INSUFFICIENT_FUNDS':
                  if (err.payload.error.details?.poolAvailable != null) {
                    userMessage = `The server pool has ${err.payload.error.details.poolAvailable} points but this requires ${err.payload.error.details.required}. Fund the pool with \`/groupsettings\` or purchase personal points with \`/buypoints\`.`;
                  } else {
