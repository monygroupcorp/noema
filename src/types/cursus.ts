...
export interface Actorum {
  ...
  update(
    id: string,
    patch: Partial<Pick<Actum, 'status' | 'exitus' | 'error' | 'completum' | 'duratio' | 'impetus' | 'materiamId' | 'signaConsumed' | 'expirat' | 'externusJobId' | 'oneshotPod' | 'deploymentHash' | 'executio' | 'progressus' | 'phaseDurations'>>
  ): Promise<Actum>
