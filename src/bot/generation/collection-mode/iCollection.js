...
const { 
 ...
 const { CollectionMenuBuilder } = require('./menuBuilder');
 const { StudioManager } = require('./studioManager')
 const { StudioAction } = require('./studioAction');
 const { gptAssist, formatters } = require('../../../services/assist');
...
const cookModeHandler = require('./collectionCook');
const exportModeHandler = require('./collectionExport');
