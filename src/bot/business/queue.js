const { taskQueue, waiting, successors, lobby, workspace, failures, getGroup } = require('../core/core.js');
const { generate } = require('../../services/make')
const studioDB = require('../../db/models/studio.js');
const {
    sendMessage,
    sendPhoto,
    sendAnimation,
...
const { addWaterMark } = require('../../services/waterMark')
const fs = require('fs');
//const { saveGen } = require('../../db/mongodb');
const { generateTripo } = require('../../services/tripo');
const fetch = (...args) => import('node-fetch').then(({default: fetch}) => fetch(...args));
const path = require('path');
const UserStats = require('../../db/models/userStats');
const userStats = new UserStats();
const GlobalStatusDB = require('../../db/models/globalStatus.js');
const globalStatusData = new GlobalStatusDB();
const { AnalyticsEvents, EVENT_TYPES } = require('../../db/models/analyticsEvents.js');
const analytics = new AnalyticsEvents();
const collectionCook = require('../generation/collectionMode/collectionCook.js');
