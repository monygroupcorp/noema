...
export const CANONICAL_FUNDAMENTA: Fundamentum[] = [
  ...
  // FUNDAMENTUM_FLUX2_KLEIN_COMFYUI is NOT offered: its unet (intella.flux2-klein-9b) is gated on
  // HuggingFace and no pod can fetch it. Restored together with ESSENTIA_KLEINEDIT once mirrored.
