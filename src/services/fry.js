...
const { lobby } = require('../bot/core/core')
const { getPhotoUrl } = require('../bot/core/bot')
const { sendPhoto, react } = require('../bot/utils')
const { checkIn } = require('../bot/business/gatekeep')
const fs = require('fs');
