...
const PromptBuilder = require('../../../src/services/comfydeploy/PromptBuilder');
const { GenerationRequest } = require('../../../src/core/generation/models');
...
describe('PromptBuilder', () => {
  ...
  describe('_finalizeRequest', () => {
    it('should ensure input_prompt is set correctly in final request', () => {
      ...
      jest.mock('../../../src/services/comfydeploy/utils/normalizeParameters', () => mockFilterModule, { virtual: true });
