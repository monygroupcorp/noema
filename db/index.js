...
const EconomyModel = require('./models/userEconomy');
const CoreModel = require('./models/userCore');
const GenerationOps = require('./operations/points');
const WorkspaceOps = require('./operations/workspace');
const { MongoClient, GridFSBucket } = require('mongodb');
const dbQueue = require('./queue');
...
class BaseDB {
    ...
    async getClient() {
        if (!this.client) {
            this.client = await MongoClient.connect(process.env.MONGO_PASS);
        }
        return this.client;
    }
